  ...
  return (
    <div className="relative">
      <li
        ...
        className="font-semibold md:text-[17px] 2xl:text-[18px] hover:text-secondary-text transition-all duration-500 cursor-pointer"
      >
      ...
      {enter && (
        ...
        >
          <li className="font-semibold md:text-[17px] 2xl:text-[18px] text-white hover:text-secondary-text transition-all duration-500">
