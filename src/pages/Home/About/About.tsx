...
const About = () => {
  ...
  return (
    <>
      <Container className="hidden md:flex gap-20 my-16 md:my-24">
        <motion.div
          style={styleLeft}
          ref={componentRef}
        ...
        >
          ...
          <p className="text-dark-light max-w-[60ch] pt-4">
            ...
            venenatis Vulputate enim nulla aliquet porttitor la. Dictumst
            quisque sagittis purus sit a. Praesent elementum facil fringilla
            est. Volutpat sed cras ornare arcu dui vivamus arcu felis. Ma etiam
            tempor orci eu lobortis elementum nibh tellus. Lectus proin nibh
      ...
      {/* for mobile */}
      <Container className="md:hidden gap-20 my-16 md:my-24">
